...
class GameScene: SKScene, SKPhysicsContactDelegate {
	...
	func setupLabels() {
		...
		//best score label top right side
		let highScoreLabel:SKLabelNode = SKLabelNode (text: "High score")
		highScoreLabel.position = CGPoint (x: frame.size.width - 14.0, y: frame.size.height - 20.0)
		...
		//best score top right side
		let highScore:SKLabelNode = SKLabelNode (text: "0")
		highScore.position = CGPoint(x: frame.size.width - 14.0, y: frame.size.height - 40.0)
		highScore.horizontalAlignmentMode = .right
		highScore.fontName = "courier-bold"
		highScore.fontSize = 14.0
		highScore.name = "highScoreLabel"
